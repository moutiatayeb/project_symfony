 ...
 */
final class Version20200618135056 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE cours CHANGE condidat_id condidat_id INT DEFAULT NULL, CHANGE formateur_id formateur_id INT DEFAULT NULL');
