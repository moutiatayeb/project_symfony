 ...
 */
final class Version20200618132656 extends AbstractMigration
{
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TABLE condidat_formateur (condidat_id INT NOT NULL, formateur_id INT NOT NULL, INDEX IDX_5C1D939B1619DB31 (condidat_id), INDEX IDX_5C1D939B155D8F51 (formateur_id), PRIMARY KEY(condidat_id, formateur_id)) DEFAULT CHARACTER SET utf8 COLLATE utf8_unicode_ci ENGINE = InnoDB COMMENT = \'\' ');
